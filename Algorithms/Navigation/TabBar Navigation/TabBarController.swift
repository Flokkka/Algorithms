...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        updateViewControllerArray(tabBarConfigPListName: "TabBarConfiguration")
        styleNavAndTabBar()
    }
    
    private func updateViewControllerArray(tabBarConfigPListName: String) {
        viewControllers = ChildControllerProvider.getControllerArrayFromPList(tabBarConfigPListName)
    }
