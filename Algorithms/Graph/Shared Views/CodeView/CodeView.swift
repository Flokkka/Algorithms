...
class CodeView: UIView {
    ...
    private func createPickerView() {
        languagePicker = UIPickerView(frame: CGRect(x: frame.size.width - 70, y: 0, width: 60, height: 80))
    ...
    private func setLanguage(_ language: Languages) {
        ...
        textStorage.deleteCharacters(in: NSRange(location: 0, length: textStorage.backingStore.length))
